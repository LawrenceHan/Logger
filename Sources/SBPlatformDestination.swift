...
public class SBPlatformDestination: BaseDestination {
    ...
    public var serverURL = URL(string: "https://api.LHWLogger.com/api/entries/") // optional
    ...
    override public func send(_ level: LHWLogger.Level, msg: String, thread: String,
    ...
    /// does a (manual) sending attempt of all unsent log entries to LHWLogger Platform
    public func sendNow() {
    ...
    /// sends a string to the LHWLogger Platform server, returns ok if status 200 and HTTP status
    ...
    func sendingPointsForLevel(_ level: LHWLogger.Level) -> Int {
    ...
    func renameJsonToSendFile() -> Bool {
        do {
            ...
            toNSLog("LHWLogger Platform Destination could not rename json file.")
            return false
        }
    }
    ...
    func dictFromFile(_ url: URL) -> [String:Any]? {
        do {
            ...
            toNSLog("LHWLogger Platform Destination could not read file \(url)")
        }
        return nil
    }
