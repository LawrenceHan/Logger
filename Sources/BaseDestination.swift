...
open class BaseDestination: Hashable, Equatable {
    ...
    open var minLevel = LHWLogger.Level.verbose
    ...
    public init(qos: QualityOfService = .utility, targetQueue: DispatchQueue? = nil) {
        let uuid = NSUUID().uuidString
        let queueLabel = "LoggerQueue-" + uuid
        queue = DispatchQueue(label: queueLabel, qos: .utility, autoreleaseFrequency: .workItem, target: targetQueue)
    }

    /// send / store the formatted log message to the destination
    /// returns the formatted log message for processing by inheriting method
    /// and for unit tests (nil if error)
    open func send(_ level: LHWLogger.Level, msg: String, thread: String, file: String,
    ...
    func formatMessage(_ format: String, level: LHWLogger.Level, msg: String, thread: String,
    ...
    func messageToJSON(_ level: LHWLogger.Level, msg: String,
    ...
    func levelWord(_ level: LHWLogger.Level) -> String {

        var str = ""

        switch level {
        case LHWLogger.Level.debug:
            str = levelString.debug

        case LHWLogger.Level.info:
            str = levelString.info

        case LHWLogger.Level.warning:
            str = levelString.warning

        case LHWLogger.Level.error:
    ...
    func colorForLevel(_ level: LHWLogger.Level) -> String {
        var color = ""
    ...
    func jsonStringFromDict(_ dict: [String: Any]) -> String? {
        ...
        do {
            ...
            print("LHWLogger could not create JSON from dict.")
        }
        return jsonString
    }
    ...
    func shouldLevelBeLogged(_ level: LHWLogger.Level, path: String,
    ...
    func passedRequiredFilters(_ level: LHWLogger.Level, path: String,
    ...
    /// returns a tuple of matched and all filters
    func passedNonRequiredFilters(_ level: LHWLogger.Level,
    ...
    func passedExcludedFilters(_ level: LHWLogger.Level,
                               path: String, function: String, message: String?) -> (Int, Int) {
    ...
    func applyFilters(_ targetFilters: [FilterType], level: LHWLogger.Level,
