...
public class FileDestination: BaseDestination {
    ...
    public override init(qos: QualityOfService, targetQueue: DispatchQueue?) {
        ...
        if let baseURL = baseURL {
            logFileURL = baseURL.appendingPathComponent("Logger-0.log", isDirectory: false)
        }
        super.init(qos: qos, targetQueue: targetQueue)
